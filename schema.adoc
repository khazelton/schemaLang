...
link:https://docs.evolveum.com/midpoint/midprivacy/phases/01-data-provenance-prototype/axiom/[Axiom] defines five basic concepts for data modeling <--> Closest link:https://www.w3.org/TR/owl2-manchester-syntax/[OWL] counterparts 

objects <--> entities +ink:https://www.w3.org/TR/owl2-manchester-syntax/
