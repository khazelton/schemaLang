...
link:https://docs.evolveum.com/midpoint/midprivacy/phases/01-data-provenance-prototype/axiom/[Axiom] defines five basic concepts for data modeling <--> Closest OWL counterparts 
